...
public class ProcesaServletFor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (numero != null && !numero.equals("")) {
            ...
            for (int index = 1; index <= numeroInt; index++) {
                if (index % 2 ==0)
            ...
            try {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Practica 16 - For</title>");
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Servlet Practica 16 - For </h1>");
